      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            {t('favorites.subtitle', 'Your saved accommodations for future trips')}
          </p>
        </div>
        ...
        {favorites.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-md mx-auto">
              {t('favorites.emptyDescription', 'Start exploring our amazing rooms and save your favorites here for quick access.')}
            </p>
            <Link 
              to="/" 
            ...
            >
              {t('favorites.exploreButton', 'Explore Rooms')}
            </Link>
          </div>
        )}
      </div>
