    ...
    },
    {
      ...
      items: [
        ...
        */
        ...
        {
          name: t('admin.navigation.features'),
          href: '/admin/features',
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.15 3.54a1 1 0 00.95.69h3.72c.969 0 1.371 1.24.588 1.81l-3.01 2.19a1 1 0 00-.364 1.118l1.15 3.54c.3.921-.755 1.688-1.54 1.118l-3.01-2.19a1 1 0 00-1.176 0l-3.01 2.19c-.784.57-1.838-.197-1.539-1.118l1.15-3.54a1 1 0 00-.364-1.118L2.64 8.967c-.783-.57-.38-1.81.588-1.81h3.72a1 1 0 00.95-.69l1.15-3.54z" />
            </svg>
          ),
